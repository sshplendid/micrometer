...
public interface Meter {
    ...
    class Id {
        ...
        // TODO: Make this package scope in 2.0.0
        @Incubating(since = "1.1.0")
        protected Id(String name, Tags tags, @Nullable String baseUnit, @Nullable String description, Type type,
    ...
    class Builder {
        ...
        // TODO: Make this private in 2.0.0
        protected Builder(String name, Type type, Iterable<Measurement> measurements) {
            this.name = name;
            this.type = type;
